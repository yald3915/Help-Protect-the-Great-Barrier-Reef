This file is the baseline code for TensorFlow - Help Protect the Great Barrier Reef--Detect crown-of-thorns starfish in underwater image data

以上文件是TensorFlow - Help Protect the Great Barrier Reef（海星目标检测大赛）比赛的baseline代码
